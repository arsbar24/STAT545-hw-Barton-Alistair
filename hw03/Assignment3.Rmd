...
```{r}
ggplot(gapminder, aes(x = year, y = lifeExp)) + geom_point() + geom_smooth(method = 'auto') # fitted curve from Jenny Bryan's deck https://speakerdeck.com/jennybc/ggplot2-tutorial
```
